...
router.post('/reschedule', async (req, res) => {
  let new_slot = moment(new Date(year,month,date)).set({h:req.body.data.hour,m:req.body.data.minute})
  console.log('booking update request',new Date(year,month,date),new_slot)
