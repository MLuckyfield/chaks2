      ...
      <Router>
        ...
        <div class='nav-filler'>
          ...
          <AuthDataProvider>
            ...
            <SecureRoute path="/account" access={['user','manager']} success={BlogFront} fail={Login}/>
            ...
            <SecureRoute path="/reservation" access={['teacher','manager']} success={Booking} fail={Login}/>
          </AuthDataProvider>
      </Router>
