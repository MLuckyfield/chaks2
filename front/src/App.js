...
会話はインストラクターがリードし、分からない英語については１つ１つ説明し、お客様が理解した上で、会話を続けます。なので、英会話に自信がない人や、正しく自然な英語を学びたい人は是非ともお試しください。
              ...
              <div id='faq'  class='master-row'>
                ...
                <div class='row'>
                  ...
                  <div class='row'>
                      <div class='col slim center border'>
                          <h2>普通の英会話教室と何が違うの？</h2>
                          <p/>普通の英会話教室と違うポイントたくさんありますがその中でも以下の３点が特徴となります。
                          <p/>1.実際の会話中に英語を教えたり、気軽に英語の質問ができる雰囲気を提供します。
                          <p/>2.入会が不必要な為、レッスン予約やテキスト代など必要ありません。来たいときに来れて帰りたいときに帰れます！
                          <p/>3.安い！安くて知りたいことを知れるそんな環境を提供しています！入会金やテキスト代もなく気軽にご利用いただけます。
                      </div>
                      <div class='col slim center border'>
                          <h2>英会話バーでも英語が学べるの？</h2>
                          <p/>もちろん英語力を向上していただけます。
                          <p/>英語を学ぶ場所の提供が私たちの一番の役目です。CHTASHACKでの英会話は自由テーマで行われます。
                          なので、英語に関する質問はいつでもできるし、インストラクターも例文や絵などで説明をしてくれます。
                          また、バーといっても英会話を楽しむことを大事としているので、音の大きい音楽を流すなどはしません。
                      </div>
                      <div class='col slim center border'>
                          <h2>バーと聞くとすこし怪しいイメージがあります。</h2>
                          <p/>私たちは一般的なバーとは違って、英語の学習を主としております。
                          もちろんバーなのでお酒の提供もありますが、それはあくまでも英会話をする環境を楽しく盛り上げる為に提供しています。
                          なので、飲みすぎて他のお客様に迷惑をかける方がいた場合にはお店から退店いただくことがございますのでご了承ください。
                      </div>
                      <div class='col slim center border'>
                          <h2>予約は必要ですか？</h2>
                          <p/>必要ありません！直接お越しください！
                      ...
                      <div class='col slim center border'>
                          <h2>他にも安い英会話はありますが、割引などありますか？</h2>
                          <p/>もちろん私たちより安い英会話教室は存在します！ただ、私たちはより自由に話しやすい環境を提供している自信があります。また、CHATSHACKには入会金や月謝などをお客様から頂戴しておりません。
                          割引に関しては今後条件付きで行う予定ではあります！
                          最新情報としてお客様へ共有する予定ですのでHPよりメールアドレスの登録をよろしくお願いいたします。
                      </div>
                      <div class='col slim center border'>
                          <h2>英会話中に飲食をすることは可能ですか？</h2>
                          <p/>もちろんです！海外のカフェやバーを意識したメニューを提供しております！
