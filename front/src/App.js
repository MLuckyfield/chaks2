...
const Front = ()=>{
    ...
    会話はインストラクターがリードし、分からない英語については１つ１つ説明し、お客様が理解した上で、会話を続けます。なので、英会話に自信がない人や、正しく自然な英語を学びたい人は是非ともお試しください。
              ...
              <div class='col'>
                ...
                <div class='row'>
                  <div class='col'><img class='nav-logo' onClick={()=>window.location.href='instagram.com/chatshack/'} src={instagram} alt="English education and event information!"></img></col>
                  ...
                  <div class='col'><img class='nav-logo' onClick={()=>window.location.href='https://www.youtube.com/channel/UCjGUSfvKKj72blxyqusTRRg'} src={youtube} alt="English entertainment!"></img>
                </div>
