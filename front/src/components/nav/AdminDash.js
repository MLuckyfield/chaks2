...
const StudentTable = ()=>{
  return <Table name='Students' api='/user/all' filter={{role: 'user'}} fields="-__v -fluency -progress -goals -students -tags -source -password -createdAt -updatedAt -role -points -active -statistics -subscriptions"/>
}
...
const Dash = ()=>{
  ...
  }else if (user.role=='teacher')
  {
    ...
    return(
      <div>
        <StaffTable/>
        <Table name='Teachers' api='/user/all' filter={{role: 'teacher'}} fields="-__v -fluency -progress -goals -students -tags -source -password -createdAt -updatedAt -role -points -active -statistics -plan -reward -subscriptions"/>
        <StudentTable/>
      </div>
    )
  }else{
