    ...
    <nav>
        ...
        {user==''||user==null||user==undefined?(
          <ul class="nav-links">
              ...
              <li>{window.location.pathname==='/online'?<a onClick={navSlide} href="#concept">FEATURES</a>:<a onClick={navSlide} href="/#products">PRODUCTS</a>}</li>
          ...
          <ul class="nav-links">
              ...
              {user.role?(<li style={{padding:'3% 7%'}}><a href='/course_management'><span class="material-icons">school</span></a></li>):''}
