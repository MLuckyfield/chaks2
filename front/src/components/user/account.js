      ...
      <div class='master-row'>
          <div class='col border'>
              ...
              <div class='col'>
                ...
                {student.first=='M'?account.plan=='premium'?<div class="btn" onClick={(e)=>{onSubmit(e,'upgrade')}}>Upgrade</div>:<div class="btn" onClick={(e)=>onSubmit(e,'downgrade')}>Downgrade</div>:''}
