      ...
      <div class="modal">
        ...
        <div style={{display:'flex',alignItems:'center',flexDirection:'column'}}>
          ...
          {props.content.student?
            ...
            <div>You are signed up!<a href='https://us05web.zoom.us/j/7973308497?pwd=MXZ4UDF4V0FMaFNDU3pQR1FwZnV0UT09'>Click Here to Join Zoom Lsson</a></div>  :`${props.content.student.first} ${props.content.student.last}`
            :<div style={{display:'flex',alignItems:'center',flexDirection:'column'}}>
