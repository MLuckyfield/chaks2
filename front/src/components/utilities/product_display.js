...
これから留学を考えている方や、外資系への転職を考えている人などへ向けたプランです！</li>
                ...
                <Popup title={"継続購入について"} num={3} button={true} content={
                  ...
                  ３．レッスンは、担当講師が対⾯で受講⽣グループに対し、英会話指導をするものです。<br/></p>
                  ...
                  (レッスンの実施場所）
                   ...
                   東京都千代田区九段南2-4–12 アビスタ九段ビル201 CHATSHACK<br/></p>
                  ...
                  <p class='indent'>① 甲に対するサービスの案内、情報提供を⾏うため<br/>

                  ② 甲より照会を受けた内容に回答するため<br/></p>

                  ２．本契約に際し、⼄が収集した個⼈情報に関しては、次の各号に定める場合を除き、第三者への提供は⾏いません。<br/>

                  　<p class='indent'>①法令の定めに従い、国または公共団体及びその委託を受けた第三者から個⼈情報の開⽰を求められた場合<br/>

                  　②個⼈の⽣命、⾝体、財産の保護のために必要があり、本⼈の同意を得ることが困難な場合 </p></p>
